 ...
 * @author Didjeeh
 */
public class WMIMonitor extends Monitor {
     ...
     * @param id
     */
    public WMIMonitor(Server server, Socket socket, long id) {
    ...
    public void setWDYH() {
        if (Monitor.wdyh == null) {
            try {
                WMIProxy.INSTANCE.setResolvePath(Directory.getExecutingDirectory(WMIMonitor.class));
